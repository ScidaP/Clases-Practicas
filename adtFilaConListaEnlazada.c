...
int main(){
    ...
    filaNueva = EnFila(filaNueva, 888);
    printf("Es fila vacia? : %d\n", EsFilaVacia(filaNueva));
    filaNueva = EnFila(filaNueva, 18);
    filaNueva = EnFila(filaNueva, 2228);
    filaNueva = EnFila(filaNueva, 4);
    printf("Frente: %d", Frente(filaNueva));
    filaNueva = deFila(filaNueva);
    return 0;
}
